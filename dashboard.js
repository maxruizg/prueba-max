...
(() => {
    ...
    switch(metrica[1]){
        case '1': 
            ...
            if(semana2 == undefined || semana2 == 0 || semana2 == '0'){ arreglo[2] = 0 }else {arreglo[2] = semana2.spend}
            if(semana3 == undefined || semana3 == 0 || semana3 == '0'){ arreglo[3] = 0 }else {arreglo[3] = semana3.spend}
            if(semana4 == undefined || semana4 == 0 || semana4 == '0'){ arreglo[4] = 0 }else {arreglo[4] = semana4.spend}
        case '2': if(semana1 == undefined || semana1 == 0 || semana1 == '0'){ arreglo[1] = 0 }else {arreglo[1] = semana1.clicks}
            if(semana2 == undefined || semana2 == 0 || semana2 == '0'){ arreglo[2] = 0 }else {arreglo[2] = semana2.clicks}
            if(semana3 == undefined || semana3 == 0 || semana3 == '0'){ arreglo[3] = 0 }else {arreglo[3] = semana3.clicks}
            if(semana4 == undefined || semana4 == 0 || semana4 == '0'){ arreglo[4] = 0 }else {arreglo[4] = semana4.clicks}
            break;
        case '3': if(semana1 == undefined || semana1 == 0 || semana1 == '0'){ arreglo[1] = 0 }else {arreglo[1] = semana1.impressions}
            if(semana2 == undefined || semana2 == 0 || semana2 == '0'){ arreglo[2] = 0 }else {arreglo[2] = semana2.impressions}
            if(semana3 == undefined || semana3 == 0 || semana3 == '0'){ arreglo[3] = 0 }else {arreglo[3] = semana3.impressions}
            if(semana4 == undefined || semana4 == 0 || semana4 == '0'){ arreglo[4] = 0 }else {arreglo[4] = semana4.impressions}
            break;
        case '4': if(semana1 == undefined || semana1 == 0 || semana1 == '0'){ arreglo[1] = 0 }else {arreglo[1] = semana1.ctr}
            if(semana2 == undefined || semana2 == 0 || semana2 == '0'){ arreglo[2] = 0 }else {arreglo[2] = semana2.ctr}
            if(semana3 == undefined || semana3 == 0 || semana3 == '0'){ arreglo[3] = 0 }else {arreglo[3] = semana3.ctr}
            if(semana4 == undefined || semana4 == 0 || semana4 == '0'){ arreglo[4] = 0 }else {arreglo[4] = semana4.ctr}
            break;
        case '5': if(semana1 == undefined || semana1 == 0 || semana1 == '0'){ arreglo[1] = 0 }else {arreglo[1] = semana1.ctc}
            if(semana2 == undefined || semana2 == 0 || semana2 == '0'){ arreglo[2] = 0 }else {arreglo[2] = semana2.ctc}
            if(semana3 == undefined || semana3 == 0 || semana3 == '0'){ arreglo[3] = 0 }else {arreglo[3] = semana3.ctc}
